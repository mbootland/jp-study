...
TIMER_COLOR = "#FF80AB"    # Hot Pink
EXPLAIN_COLOR = "#FFF176"  # Light Yellow
PAUSE_COLOR = "#B0BEC5"

FONT_Q = ("Noto Sans CJK JP", 24, "bold")  # Prefer CJK font if available
FONT_A = ("Noto Sans CJK JP", 20, "bold")
FONT_TIMER = ("Consolas", 16, "bold")
FONT_EXPL = ("Noto Sans CJK JP", 16, "bold italic")
